...
public class LikedSongsServiceTests
{
    ...
    public void SetUp()
    {
        _dbContextOptions = new DbContextOptionsBuilder<SwarContext>()
            .UseInMemoryDatabase("InMemoryLikedSongsDb")
            .Options;
    ...
    public async Task AddSongToLikedSongs_UserInactive_ThrowsInactiveAccountException()
    {
        ...
        // Act & Assert
        Assert.ThrowsAsync<InactiveAccountException>(() =>
            _likedSongsService.AddSongToLikedSongs(user.UserId, "song123"));
    }
    ...
    public async Task RemoveSongFromLikedSongs_SongNotLiked_ThrowsEntityNotFoundException()
    {
        ...
        Assert.ThrowsAsync<EntityNotFoundException>(() =>
            _likedSongsService.RemoveSongFromLikedSongs(user.UserId, "song123"));
    }
    ...
    public async Task GetAllLikedSongs_ValidUser_ReturnsLikedSongs()
    {
        ...
        var l1 = new LikedSong { UserId = user.UserId, SongId = "song1", LikedDate = DateTime.Now.AddMinutes(-10) };
        var l2 = new LikedSong { UserId = user.UserId, SongId = "song2", LikedDate = DateTime.Now.AddMinutes(-5) };
